"""
Django settings for InstaTian project.
...
SECRET_KEY = 'no8778n+3e2+&2%17lla115(a*e*&y%@+0z1y6&%ktcya(n6l_'
...
WSGI_APPLICATION = 'InstaTian.wsgi.application'
...
# customize the user model, directly use app.class_mame
